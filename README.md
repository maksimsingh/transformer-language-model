...
Encodes characters into embeddings
Adds positional information
Processes sequences through Transformer blocks
Predicts the next character using probability distribution
Usage

Run the model with a specific dataset:

python language_model.py input1.txt

or

python language_model.py input2.txt
